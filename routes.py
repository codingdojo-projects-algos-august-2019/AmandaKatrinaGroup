...
from controller_functions import index, register, login, logout, dashboard, check_email,\
    show_blog, show_blogs, show_blogs_by_tag, show_tag_text, delete_blog_image, delete_user_image, \
...
app.add_url_rule('/users/<id>/image/delete', view_func=delete_user_image)
